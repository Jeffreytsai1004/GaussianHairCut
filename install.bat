...
@CALL git clone https://github.com/facebookresearch/detectron2.git %EXT_DIR%\Matte-Anything\detectron2
...
@CALL python -m pip install --upgrade pip 
@CALL python -m pip install ninja cmake charset-normalizer pyside2 requests future idna
...
@CALL pip install fvcore kornia matplotlib pytorch3d pyyaml charset-normalizer pyside2 requests future idna
