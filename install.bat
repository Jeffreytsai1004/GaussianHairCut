...
@CALL git clone git@github.com:facebookresearch/segment-anything.git %PROJECT_DIR%\ext\Matte-Anything\segment-anything
@CALL cd %PROJECT_DIR%\ext\Matte-Anything\segment-anything && pip install -e .
@CALL cd %PROJECT_DIR%\ext\Matte-Anything
@CALL git clone https://github.com/conansherry/detectron2 %PROJECT_DIR%\ext\Matte-Anything\detectron2
@CALL cd %PROJECT_DIR%\ext\Matte-Anything\detectron2 && pip install -e .
...
@CALL copy %PROJECT_DIR%\resource\Matte-Anything\ %PROJECT_DIR%\ext\Matte-Anything\
@CALL cd %PROJECT_DIR%
@CALL "%~dp0condabin\micromamba.bat" deactivate matte_anything
...
@CALL "%~dp0condabin\micromamba.bat" deactivate openpose
...
@CALL copy %PROJECT_DIR%\resource\PIXIE\pixie_data %PROJECT_DIR%\ext\PIXIE\data
...
@CALL cd %PROJECT_DIR%
@CALL "%~dp0condabin\micromamba.bat" deactivate pixie-env
